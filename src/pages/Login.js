...
import { Link, Box, Grid, Typography, Paper, TextField, CssBaseline, Button, Avatar } from '@material-ui/core/';
...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await signInWithEmailAndPassword(auth, cred.email, cred.password).then((res) => {
